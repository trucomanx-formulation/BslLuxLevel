...
The images were placed in data packages
...
\label{fig:system}
\end{figure}
In each image of the packages was selected two regions, of $250\times200$ pixels, 
corresponding to the regions with two different illumination levels, 
as shown with black lines in the Fig. \ref{fig:regions}. In the right side of the \ref{fig:regions}  we have the
